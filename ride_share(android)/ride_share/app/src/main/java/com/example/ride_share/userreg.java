...
public class userreg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e2 = findViewById(R.id.editTextTextPersonName29);
        e3 = findViewById(R.id.editTextTextPersonName20);
        e4 = findViewById(R.id.editTextTextPersonName21);
        e5 = findViewById(R.id.editTextTextPersonName22);
        e6 = findViewById(R.id.editTextTextPersonName23);
        e7 = findViewById(R.id.editTextTextPersonName24);
        e8 = findViewById(R.id.editTextTextPersonName25);
        e9 = findViewById(R.id.editTextTextPersonName26);
        e10 = findViewById(R.id.editTextTextPersonName27);
...
//                }
    ...
    private void uploadBitmap(final String title) {
        pd=new ProgressDialog(userreg.this);
...
//                        Toast.makeText(Upload_agreement.this, "Report Sent Successfully", Toast.LENGTH_LONG).show();
                            if (obj.getString("task").equalsIgnoreCase("success")) {
                                ...
                                Toast.makeText(userreg.this, "Successfully uploaded", Toast.LENGTH_LONG).show();
