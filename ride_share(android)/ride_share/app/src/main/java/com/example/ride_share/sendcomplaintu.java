...
public class sendcomplaintu extends AppCompatActivity {
    EditText e1;
    Button b1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sendcomplaintu);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (complaint.equalsIgnoreCase("")) {
                    ...
                    RequestQueue queue = Volley.newRequestQueue(sendcomplaintu.this);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (res.equalsIgnoreCase("valid")) {
                                    Toast.makeText(sendcomplaintu.this, "send successfully ", Toast.LENGTH_SHORT).show();
                                    ...
                                    Toast.makeText(sendcomplaintu.this, "please try again", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        Intent i = new Intent(getApplicationContext(),complaintu.class);
        startActivity(i);
    }
}
